...
public class ComponentSetup {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<SkintDownBlock.BonfireData>> BONFIRE_DATA = COMPONENTS.registerComponentType("bonfire_data", builder -> builder.persistent(SkintDownBlock.BonfireData.CODEC).networkSynchronized(SkintDownBlock.BonfireData.STREAM_CODEC));
